...
public class ArtifactRegistryGradlePlugin implements Plugin<Object> {
  ...
  public void apply(Object o) {
      ...
      if (o instanceof Project) {
        ...
        try {
          ...
          grdl.beforeSettings(settings -> {
            logger.error("Applying now to " + settings.getSettingsDir().toString());
    ...
    private ArtifactRegistryPasswordCredentials getArtifactRegistryPasswordCredentials(ProviderFactory providerFactory, ArtifactRegistryPasswordCredentials crd) throws IOException {
    ...
    private void configureArtifactRegistryRepository(
        ...
        logger.error("Configuring repository" + u.toString());
